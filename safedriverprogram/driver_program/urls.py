...
urlpatterns = [
    ...
    path('dashboard/all-drivers/', views.admin_driver_dashboard, name='admin_driver_dashboard'),
    path('dashboard/delete-driver/<int:user_id>/', views.admin_delete_driver, name='admin_delete_driver'),
